...
<section class="container">
    ...
    <form class="border p-3 form" action="<?=base_url('admin/addTipoIncidencias')?>" method="POST"
        enctype="multipart/form-data">

        <div class="form-group col-md-12">
            <label class="label">Tipo de incidencia</label>
            <div class="control">
                <input name='tipoIncidencia' value='<?=old('tipoIncidencia')?>' class="input" type="text"
                    placeholder="">
            </div>
