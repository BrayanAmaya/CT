     ...
     <div class="form-group col-md-12">
        <p class="control">
            <a style=" text-decoration: none;" class="btn btn-primary"
                ...
                <span class="has-text-white">Regresar</span>
            </a>
        </p>
    </div>  
            <h4 class="label">
                Fecha de reporte de: 04/06/2022 Hasta: 08/06/2022 , estados de la incidencia: Pendiente, tipo de
                    incidencia: Daño a equipo, del usuario: dtbrayanamaya01
            </h4>
    </div>   
                                ...
                                <div class="card" style="width: 22rem;">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <div class="content">
                                            ...
                                            <br>
                                            <?php if ($key->estado == 0) : ?>
                                                <p>Resuelto por <?= $key->mostrarUsuario($key->resueltoPor) ?> <time datetime="2016-1-1"><?= $key->date_update->humanize() ?></time></p>
                                            <?php endif; ?>
                                            <?php if ($key->estado == 1) : ?>
                                                <a href="<?= base_url(route_to('viewIncidencia')) ?>?id=<?= password_hash($key->idIncidencia, PASSWORD_DEFAULT) ?>" class="btn btn-primary">Resolver </a>
                                            <?php endif; ?>
                                            <a href="#Modal<?= $key->idIncidencia ?>" data-toggle="modal" class="btn btn-primary">Ver</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <?php foreach ($incidencias as $key) : ?>
            <div class="modal bd-example-modal-lg" id="Modal<?= $key->idIncidencia ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
