...
<section class="section">
    ...
    <div class="container">
        ...
        <form class="border p-3 form"
            action="<?=base_url('user/actualizarPerfil')?>?id=<?= password_hash($usuario->idUsuario,PASSWORD_DEFAULT)?>"
            method="POST">
            ...
            <div class="form-row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="control">
                        <input name='passwordAnterior' class="input" type="password" placeholder="Contraseña">
                    </div>
                    <p class="is-danger help"><?=session('errorsP.password')?></p>
                </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="control">
                        <input name='c-password' class="input" type="password" placeholder="Contraseña">
                    </div>
                </div>
